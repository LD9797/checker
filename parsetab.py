...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','parser.py',51),
  ('statement -> expression','statement',1,'p_statement_expr','parser.py',55),
  ...
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','parser.py',69),
  ...
  ('expression -> NAME','expression',1,'p_expression_name','parser.py',81),
]
